...
public class NestedDataType extends BaseDataType {

    private final List<ColumnDeclaration> columns;

    public NestedDataType(List<ColumnDeclaration> columns) {
        super(DataTypes.NESTED);
    ...
    public String getSqlDefinition() {
        return getSqlDefinitionForComplexType(columns);
    }
}