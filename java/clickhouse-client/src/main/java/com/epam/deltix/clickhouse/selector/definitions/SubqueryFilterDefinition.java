 ...
 */
public interface SubqueryFilterDefinition<T> extends FilterNode<T> {
     ...
     */
    SearchRequestDefinition<T> getFilterValue();

    /**
     * A definition for a search subquery.
     */
    void setFilterValue(SearchRequestDefinition<T> searchRequestDefinition);
}